      ...
      tabItem(tabName = "prediction",
              fluidPage(
                box(
                  ...
                  width = 12, solidHeader = TRUE,
                  numericInput("input_x2", "Enter Number of Transactions:", value = 8000, min = 8000, max = 15000),
                  numericInput("input_x5", "Enter Number of Advertisements:", value = 20000, min = 20000, max = 60000),
